...
var find_window_border = "#455990"; // the border color of pop-up window
...
var find_root_node = 's'; // Leave as null to search entire doc or put id of div to search (ex: 'content'). Ver 5.0a - 7/18/2014
...
function create_div(dleft, dtop, dwidth, dheight)
{
	...
	+ 'Chinese cartoon finder 9000</div>';
	...
	+ ';border: 2px solid ' + find_text_color
	+ ';float: right'
	+ ';">'
...
// This part creates the instructions and the "find" button
	...
	+ '<form onsubmit="return false;"><input type="search" size="29" maxlength="29" id="fwtext"'
	+ ' onchange="resettext();" placeholder="Enter Japanese title of the cartoon">'
...
document.write('<input style="width:16px;" src="images/search.png" type="image" '
	+ ' onclick="show();">');
